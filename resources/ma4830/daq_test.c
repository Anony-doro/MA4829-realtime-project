...
printf("\f\n\n\n");
printf("Demonstration Routine for PCI-DAS 1602\n");
printf("Acessing Badr[] locations\n\n");
...
while(1)
{
														...
														//*****************************************************************************																																	
printf("\f\n\n\n");
printf("Repeated Reading of DIO and DAC\n");
printf("\nCtrl-C to Exit\n\n");				// Exit loop
...
//*****************************************************************************************************************
// Unreachable code - CTRL-C Exits and returns to Calling Function
